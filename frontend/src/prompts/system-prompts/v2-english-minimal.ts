...
export function createSystemPrompt(context?: string): string {
  return `You are a precise text editor command parser. Your task is to translate user's natural language instructions into structured JSON command objects.
